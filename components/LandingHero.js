...
function LandingHero({}) {
  return (
    <div className="h-full bg-custom-gray pt-16 pb-40">
      <div className="absolute inset-x-0 md:mt-64 sm:mt-12 bg-white mx-auto w-9/12 flex flex-col items-center justify-center h-56 z-10 shadow-lg text-center px-5">
