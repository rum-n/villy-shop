...
function ContactSection({}) {
  return (
    <div className="h-full bg-custom-blue pt-8 pb-40 text-center mx-auto">
      <h3 className="text-2xl font-medium mb-8">Contact</h3>
      <div className="absolute inset-x-0 lg:mt-64 sm:mt-20 bg-white mx-auto w-9/12 flex flex-col items-center justify-center h-56 z-10 shadow-lg text-center pb-10">
        ...
        <button className="shadow-lg rounded-md py-2 px-10 bg-black text-white">
          Send
        </button>
      </div>
      <img
